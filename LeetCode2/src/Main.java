...
//        System.out.println(isAnagram(s, t));
        ...
        symmetricSubstactTwoArrays(arr1, arr2);
...
//                char c = symbols[i];
//                if (c == '(' || c == '{' || c == '[') {
//                    //System.out.println("–ј——ћј“–»¬ј≈“—я открывающа€, индекс " + counter);
//                    stack.push(c);
//                    stackOfIndexes.add(i);
//                    //System.out.println("Ќа стек помещена открывающа€");
//                }
//
//                if (c == ')' || c == '}' || c == ']') {
//                    //System.out.println("–ј——ћј“–»¬ј≈“—я закрывающа€, индекс " + counter);
//                    if(i == 0) {
//                        stackOfIndexes.add(i);
//                    }
//                    if (!stack.isEmpty()) {
//                        //System.out.println("—тек непустой");
...
//                    }
    ...
    //Ex Ц A={12,24,7,36,14} and B={11,26,7,14}.
    ...
    //A ^ B = {7,14}
    //Symmetric difference of A and B after sorting= [A U B] Ц [ A ^ B] = {11,12,24,26,36}.
    ...
    public static void printValuesFromArrayWithCountRepeatingDigits(int[] inputArray) {
         Map<Integer, Integer> map = new HashMap<>();
        for (int i = 0; i < inputArray.length; i++) {
            ...
            map.computeIfPresent(inputArray[i], (k,v) -> v + 1);
        }
    }
